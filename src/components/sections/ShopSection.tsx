...
const shopProducts = [
  {
    name: 'Garlic Chive',
    price: 'Rs 25',
    photo: '/images/product-specific/garlicChivePhoto',
  ...
  },
  {
    name: 'Eggplant',
    price: 'Rs 25',
    photo: '/images/product-specific/eggplantPhoto',
  ...
  },
  {
    name: 'Flaming Katy',
    price: 'Rs 25',
    photo: '/images/product-specific/flamingKathyPhoto',
  ...
  },
  {
    name: 'Jade Plant',
    price: 'Rs 50',
    photo: '/images/product-specific/jadePlantPhoto',
  ...
  },
  {
    name: 'Stonecrop',
    price: 'Rs 50',
    photo: '/images/product-specific/stonecropPhoto',
  ...
  },
  {
    name: 'Turtle Vine',
    price: 'Rs 25',
    photo: '/images/product-specific/turtleVinePhoto',
  ...
  },
  {
    ...
    price: 'Rs 40',
    photo: '/images/product-specific/dolipranePhoto',
  ...
  },
  {
    name: 'Christmas Deco',
    price: 'Rs 50',
    photo: '/images/product-specific/christmasDeco',
    message: "Hi Danielle! I'd like to pre-order a Christmas Deco for Rs 50",
    description:
    ...
    <div className="space-y-8 sm:space-y-12">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
        {shopProducts.map((product) => (
          <Card key={product.name} className="overflow-hidden hover:shadow-xl transition-shadow flex flex-col">
